...
public class ComCustomer {
	...
	public String toString() {
		return "ComCustomer [comCode=" + comCode + ", customerNumber=" + customerNumber + ", customerCeo=" + customerCeo
				+ ", customerName=" + customerName + ", customerAddress=" + customerAddress + ", customerPhone="
				+ customerPhone + ", customerCreditNumber=" + customerCreditNumber + ", customerContactNumber="
				+ customerContactNumber + ", customerCategory=" + customerCategory + ", customerRemarks="
				+ customerRemarks + "]";
	}
