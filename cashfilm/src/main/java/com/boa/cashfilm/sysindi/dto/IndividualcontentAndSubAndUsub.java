...
public class IndividualcontentAndSubAndUsub {
	...
	/**
	 * @return the individualSubjectName
	 */
	public String getIndividualSubjectName() {
		return individualSubjectName;
	}
	/**
	 * @param individualSubjectName the individualSubjectName to set
	 */
	...
	/**
	 * @param userIndividualSubjectName the userIndividualSubjectName to set
	 */
	...
	/**
	 * @return the individualContentRegistrationDay
	 */
	public String getIndividualContentRegistrationDay() {
		return individualContentRegistrationDay;
	}
	/**
	 * @param individualContentRegistrationDay the individualContentRegistrationDay to set
	 */
